  ...
  for (int npu_id = 0; npu_id < num_npus; npu_id++) {
    ...
    if (npu_id == 0) {
      for (uint32_t mb = 0; mb < num_microbatches; mb++) {
        ...
        fwd_send->set_comm_tag(parallelism_comparison_pipeline_parallel_get_tag(0, 1, mb, 1));
      ...
      for (uint32_t mb = 0; mb < num_microbatches; mb++) {
        ...
        bwd_ig_recv->set_comm_tag(parallelism_comparison_pipeline_parallel_get_tag(1, 0, mb, 0));
        if (mb == 0) {
      ...
      for (uint32_t mb = 0; mb < num_microbatches; mb++) {
        ...
        fwd_recv->set_comm_tag(parallelism_comparison_pipeline_parallel_get_tag(
      ...
      for (uint32_t mb = 0; mb < num_microbatches; mb++) {
        ...
        bwd_ig_send->set_comm_tag(parallelism_comparison_pipeline_parallel_get_tag(
      ...
      for (uint32_t mb = 0; mb < num_microbatches; mb++) {
        ...
        fwd_send->set_comm_size(fwd_comm_size);
        fwd_send->set_comm_tag(parallelism_comparison_pipeline_parallel_get_tag(
      ...
      for (uint32_t mb = 0; mb < num_microbatches; mb++) {
        ...
        bwd_ig_recv->set_comm_size(bwd_ig_comm_size);
        bwd_ig_recv->set_comm_tag(parallelism_comparison_pipeline_parallel_get_tag(
