...
class FlexFlow2ChakraConverter:
    ...
    def get_node_type(self, ff_node):
        ...
        if node_type == "COMP_NODE":
            ...
            return ChakraNodeType.COMM_SEND_NODE
    ...
    def convert_FF_node_to_CK_node(self, ff_node):
        ...
        try:
            ...
            elif ck_node.node_type == ChakraNodeType.COMM_SEND_NODE:
            ...
            print(f"convert_FF_node_to_CK_node failed on \"{self.get_label(ff_node)}\"")
            sys.exit(1);
                ...
                # communication nodes
                    ...
                    if (ck_node.comm_src == npu_id) or (ck_node.comm_dst == npu_id):
                        ...
                        if ck_node.comm_src == npu_id:
                            ...
                            ck_comm_node.node_type = ChakraNodeType.COMM_SEND_NODE
                        elif ck_node.comm_dst == npu_id:
                            ck_comm_node.name = "COMM_RECV_NODE"
                            ck_comm_node.node_type = ChakraNodeType.COMM_RECV_NODE
